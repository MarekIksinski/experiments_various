...
to do:
    ...
    *button to clear conversation context (added in this version)
"""
import os
import sys
import base64
...
class MultiFunctionApp(QWidget):
    ...
    def init_ui(self):
        ...
        # File selection layout for image/text attachments
    ...
    def reset_conversation(self):
        """Reset the conversation context by clearing all history"""
        self.chat_history = []
        self.chat_history_display.setText("")
        self.prompt_entry.setText("")
        self.output_entry.setText("Conversation reset")
